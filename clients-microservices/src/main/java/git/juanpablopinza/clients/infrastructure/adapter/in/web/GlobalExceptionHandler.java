...
import git.juanpablopinza.clients.domain.exception.ConflictoException;
import git.juanpablopinza.clients.domain.exception.DominioException;
import git.juanpablopinza.clients.domain.exception.NoEncontradoException;
import git.juanpablopinza.clients.domain.exception.SolicitudInvalidaException;
